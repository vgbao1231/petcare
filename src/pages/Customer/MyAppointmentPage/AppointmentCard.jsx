...
const AppointmentCard = ({ appointment }) => {
    ...
    const [appointmentDetail, setAppointmentDetail] = useState({ appointment: {}, details: [], order: { items: [] } });
        ...
        >
            ...
            <Box sx={{ flexGrow: 1 }}>
                <Box sx={{ display: 'flex', mb: 1, gap: 2 }}>
                    <Typography fontWeight={700}>{branch_id === 0 ? 'At-Home Visit' : 'In-Store Visit'}</Typography>
                    <Chip
